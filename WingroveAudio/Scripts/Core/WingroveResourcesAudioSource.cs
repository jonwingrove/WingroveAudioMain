    ...
    public class WingroveResourcesAudioSource : BaseWingroveAudioSource
    {
        ...
        void Load()
        {
            if (m_audioClip == null)
            {
                ...
                UnityEngine.SceneManagement.SceneManager.sceneLoaded += UnloadOnLevelChange;
            }
        }
        ...
        void UnloadOnLevelChange(UnityEngine.SceneManagement.Scene scene, UnityEngine.SceneManagement.LoadSceneMode lsm)
        {
            if (m_onlyUnloadOnLevelChange)
            {
                Unload();
