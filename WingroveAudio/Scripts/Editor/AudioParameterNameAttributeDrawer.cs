    ...
    public class AudioParameterNameAttributeDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (WingroveRoot.Instance != null)
            {
                ...
                {
                    int inWhichBank = WingroveRoot.Instance.FindParameter(testString);
                    ...
                    {
                        foreach (string evName in WingroveRoot.Instance.m_audioNameGroups[bankIndex].GetParameters())
                        {
                    ...
                    if (selected != 0)
                    {
                        testString = WingroveRoot.Instance.m_audioNameGroups[bankIndex].GetParameters()[selected - 1];
                    }
                    ...
                    if (offerAdd)
                    {
                        ...
                        {
                            WingroveRoot.Instance.m_audioNameGroups[bankIndex].AddParameter(testString);
